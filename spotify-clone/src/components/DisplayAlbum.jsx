...
const DisplayAlbum = ({ album }) => {
  ...
  return albumData ? (
    <>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-5 mt-10 mb-4 pl-2 text-[#a7a7a7]">
      ...
      {songsData.map((item, index) => (
        <div
          ...
          key={index}
          className="grid grid-cols-1 sm:grid-cols-5 gap-2 p-2 items-center text-[#a7a7a7] hover:bg-[#ffffff2b] cursor-pointer"
        >
